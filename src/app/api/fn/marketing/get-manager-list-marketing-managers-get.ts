...
export function getManagerListMarketingManagersGet(http: HttpClient, rootUrl: string, params: GetManagerListMarketingManagersGet$Params, context?: HttpContext): Observable<StrictHttpResponse<any>> {
