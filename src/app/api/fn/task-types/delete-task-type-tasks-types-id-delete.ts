...
export function deleteTaskTypeTasksTypesIdDelete(http: HttpClient, rootUrl: string, params: DeleteTaskTypeTasksTypesIdDelete$Params, context?: HttpContext): Observable<StrictHttpResponse<any>> {
