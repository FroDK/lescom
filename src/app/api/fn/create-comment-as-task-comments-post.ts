...
export function createCommentAsTaskCommentsPost(http: HttpClient, rootUrl: string, params: CreateCommentAsTaskCommentsPost$Params, context?: HttpContext): Observable<StrictHttpResponse<number>> {
